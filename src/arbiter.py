...
Windowing is the pool's `max_workers` — at most `workers` calls in flight, queued
...
`shutdown` draws the queued-vs-running distinction: queued futures are
cancelled (unbilled work,
